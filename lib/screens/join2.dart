                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          ...
                          Container(padding: EdgeInsets.symmetric(
                              horizontal: 5.w), margin: EdgeInsets.only(
                              left: 4.w),
                      ...
                      Padding(
                        ...
                        child: SizedBox(width: double.infinity, child: Text('Add your email or phone',
                      ...
                      MyTextField(
                        top: 65.h, hintText: 'Email or Phone*', autoFocus: true,),
                      Padding(
